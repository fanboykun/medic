            ...
            <div class="ml-auto md:flex items-center md:divide-x md:divide-gray-200 md:dark:divide-gray-700">
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-slate-600 dark:text-gray-500  bg-gray-200 dark:bg-white hover:bg-gray-600/20 dark:hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
