            ...
            <div class="py-8 px-4 mx-auto w-full lg:py-8">
                <div>
                    <div class=" flex justify-between mb-4 items-center">
                        ...
                        <button type="button" wire:click="goToFullUpdate()" wire:target="goToFullUpdate()" wire:loading.attr="disabled" wire:loading.class="bg-indigo-400 opacity-50" class="inline-flex mx-2 items-center px-5 py-3 text-sm font-medium text-center text-white bg-indigo-700 rounded-lg focus:ring-4 focus:ring-indigo-200 dark:focus:ring-indigo-900 hover:bg-indigo-800">
                            Go to Full Update
                        </button>
                    </div>
                    ...
                    <form wire:submit="updateMedicine" class="grid gap-y-4">
                        ...
                        <div class="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-6 dark:bg-slate-800 px-2 py-4">
                            ...
                            <div class="w-full lg:col-span-3 col-span-3">
