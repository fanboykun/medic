<div>
    ...
    <section class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
        ...
        <div class="mt-6 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 py-2 px-4 rounded-xl">
          <dl class="divide-y divide-gray-100 dark:divide-gray-800">
            ...
            <div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <div class="flex justify-between w-full sm:col-span-2 pr-2">
                ...
                <p class="text-xs dark:text-gray-200 text-gray-700">Price Diff : <span class=" {{ $medicine->price_diff < 0 ? 'dark:text-red-500 text-red-600' : 'dark:text-emerald-500 text-emerald-700' }} ">Rp {{number_format($medicine->price_diff, 0, ',','.')}} </span></p>
              </div>
            </div>
            <div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <div class="px-4 py-4 md:grid md:grid-cols-3 md:gap-4 sm:px-0">
                ...
                <ul role="list" class="divide-y divide-gray-100 rounded-md border border-gray-200">
                    ...
                    <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                      <div class="flex w-0 flex-1 items-center">
                        ...
                        <div class="ml-4 flex lg:flex-row flex-col min-w-0 flex-1 gap-2">
