<div>
    ...
    <section class="bg-white dark:bg-gray-800 rounded-lg">
        ...
        <div x-data="{
            ...
            <!-- Medicine Form -->
            <div x-data="{ m_tab: 'add_medicine' }" x-show="currentTab == 'medicine_form'" x-cloak class="pb-4 px-4 mx-auto w-full lg:pb-8 bg-gray-50 dark:bg-inherit flex items-center flex-col">
                  <!-- Tabs -->
                <div class="flex justify-center w-fit text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 bg-inherit rounded-t-xl">
                    <ul class="flex flex-wrap -mb-px">
                        <li class="mr-2">
                            <button x-on:click="m_tab = 'add_medicine'" :class="m_tab == 'add_medicine' ? 'text-blue-600 border-blue-600  dark:text-blue-500 dark:border-blue-500' : 'border-transparent  hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'" class="inline-block p-4 border-b-2 rounded-t-lg transition-all duration-200 ease-linear">Add New Medicine</button>
                        </li>
                        <li class="mr-2">
                            <button x-on:click="m_tab = 'select_medicine'" :class="m_tab == 'select_medicine' ? 'text-blue-600 border-blue-600  dark:text-blue-500 dark:border-blue-500' : 'border-transparent  hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'" class="inline-block p-4 border-b-2 rounded-t-lg disabled:opacity-70 transition-all duration-200 ease-linear">Select Existing Medicine</button>
                        </li>
                    </ul>
                </div>

                <div x-show="m_tab == 'add_medicine'" class="w-full">
                    <div class="flex justify-between items-center pb-4">
